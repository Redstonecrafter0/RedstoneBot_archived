...
public class Time implements ServerCommand {
    @Override
    public boolean onCommand(TextChannel channel, Member member, Message message, String[] args) {
        ...
        eb.setDescription("Es ist " + new SimpleDateFormat("HH:mm:ss").format(System.currentTimeMillis()) + ".");
    ...
    public MessageEmbed.Field help() {
        return new MessageEmbed.Field(Main.commandPrefix + " time", "Zeigt die aktuelle Server zeit.", false);
    }

    @Override
    public String usage() {
        return Main.commandPrefix + " time";
    }
}
